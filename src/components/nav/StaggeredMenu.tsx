...
export default function StaggeredMenu({
  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Hauptnavigation">
            ...
            {items && items.length ? (
              ...
              <li className="sm-panel-itemWrap" aria-hidden="true">
                <span className="sm-panel-item">
                  <span className="sm-panel-itemLabel">Keine Einträge</span>
                </span>
              </li>
            )}
          </ul>
          {displaySocials && socialItems && socialItems.length > 0 && (
            <div className="sm-socials" aria-label="Soziale Medien">
