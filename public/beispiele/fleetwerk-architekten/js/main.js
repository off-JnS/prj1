/* ==========================================================================
   Fleetwerk Architekten — Professional tier demo
   Scroll reveals, sticky header state, animated counters, project filter,
...
(function () {
  ...
  if (toggle && nav) {
    ...
    // Studio card at the foot of the Werkverzeichnis menu (hidden on desktop via CSS)
    nav.insertAdjacentHTML(
      "beforeend",
      '<div class="main-nav__meta">' +
        "Admiralitätstraße 17, Fleetinsel<br>" +
        '<a href="tel:+494055576412">040 555 764 12</a> · Erstgespräch im Studio' +
      "</div>"
    );
  ...
  if (counters.length) {
    var animateCounter = function (el) {
      ...
      var format = function (value) { return String(value); };
  ...
  if (form) {
    ...
    var rules = [
      ...
      },
      {
        ...
        validate: function (el) {
          return el.value ? "" : "Bitte wählen Sie die Projektart aus.";
        }
      },
      {
